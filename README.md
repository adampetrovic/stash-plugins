...
Custom plugins for [Stash](https://stashapp.cc).

## Source Index URL

Add this URL in **Settings → Plugins → Available Plugins**:
...
| [Image Deduplication](plugins/image-dedup/) | Finds duplicate and near-duplicate images using perceptual hashing |
